...
export class TableauComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log("userId from table: "+this.userId);
    this.park.getAdminListReservation(this.userId)
       .subscribe( data=>{
        ...
        console.log("dateE:::::"+this.dateE)
         console.log("listAdminReservation: "+JSON.stringify(resJSON[0]))} );
  ...
  /*   this.userId = localStorage.getItem('userId');
    ...
    if ( s === 'sup' || s === 'admin' ) {
      ...
      this.park.getListReservation(this.userId).subscribe((res) => {
        this.marker = res;
      });
    }
