...
//   ngOnInit(): void {
//     this.auth.getAllPark(" ")
//     .subscribe(
//        res => {console.log("All Park: "+res);
// this.marker = res;
//    const resSTR = JSON.stringify(res);
//       const resJSON = JSON.parse(resSTR);
//      const tt= JSON.stringify(resJSON)
//               for (let i = 0 ; i < tt.length ; i++) {
// console.log("latitude of park is: "+ this.marker[i].latitude)
//           this.latitude.push(Number(this.marker[i].latitude));
//           this.longitude.push(Number(this.marker[i].longitude));
//           console.log('log' , this.longitude);
...
function popupOptions(popupOptions: any) {
